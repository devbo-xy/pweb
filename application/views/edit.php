				...
				<div class="card-body">
					<form action="" method="post" class="needs-validation" novalidate>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="nama_mhs" id="nama_mhs" placeholder="Masukan nama Karyawan" autocomplete="off" required value="<?=$nilai['nama_karyawan']?> ">
						...
						<div class="form-group">
							...
							<input type="n_kontrak" class="form-control" name="n_kontrak" id="n_kontrak" placeholder="Masukan nilai pertemuan 1" autocomplete="off" required value="<?=$nilai['nilai1']?> ">
							<div class="invalid-feedback">
								Anda belum memasukan nilai pertemuan 1.
							</div>
						</div>
						<div class="form-group">
							<label for="n_jabatan">Jabatan</label>
							<input type="n_jabatan" class="form-control" name="n_jabatan" id="n_jabatan" placeholder="Masukan nilai pertemuan 2" autocomplete="off" required value="<?=$nilai['nilai2']?> ">
							<div class="invalid-feedback">
